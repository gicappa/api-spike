...
public class ResourceBodyEndpoint {
    ...
    public Response get(@Context HttpServletRequest request) throws OAuthSystemException {
        ...
        try {
            ...
            if (ClientOAuthInfo.ACCESS_TOKEN_VALID.equals(accessToken)) {
            ...
            if (ClientOAuthInfo.ACCESS_TOKEN_EXPIRED.equals(accessToken)) {

                // Return the OAuth error message
                OAuthResponse oauthResponse = OAuthRSResponse
                        .errorResponse(HttpServletResponse.SC_UNAUTHORIZED)
                        .setRealm(ClientOAuthInfo.RESOURCE_SERVER_NAME)
            ...
            if (ClientOAuthInfo.ACCESS_TOKEN_INSUFFICIENT.equals(accessToken)) {
